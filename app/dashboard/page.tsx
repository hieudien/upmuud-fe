        ...
        {aiResponse ? (
          <>
            <div className={`bg-indigo-50 p-6 rounded-2xl border}`}>
              <p className="text-md text-gray-700 rounded-2xl border-primary-calm">"{aiResponse.note}"</p>
            </div>
            <div className={`mt-5 bg-indigo-50 p-6 rounded-2xl shadow-xl border-l-4 border-primary-calm animate-fadeIn ${isHighlighted ? 'animate-highlight' : ''}`}>
